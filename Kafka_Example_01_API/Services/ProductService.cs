namespace Kafka_Example_01_API.Services
{
    public class ProductService : IProductService
    {
        ...
        public TableProduct UpdateQuantity(string key, Guid productId, decimal quantity, bool increase)
        {
        ...
        public TableProduct UpdatePrice(string key, Guid productId, decimal price)
        {
            var p = _inMem.Memory.FirstOrDefault(x => x.Key == key).Value;
